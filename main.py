...
df_95 = pd.concat([time_95, new_column_95], axis=1, ignore_index=True)
...
df_98 = pd.concat([time_98, new_column_98], axis=1, ignore_index=True)
...
df_ON = pd.concat([time_ON, new_column_ON], axis=1, ignore_index=True)
...
df_ONN = pd.concat([time_ONN, new_column_ONN], axis=1, ignore_index=True)
...
df_LPG = pd.concat([time_LPG, new_column_LPG], axis=1, ignore_index=True)
