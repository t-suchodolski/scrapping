...
for prices in list_price:
    all_prices.append(float(prices.text.strip().replace(",",".").replace('-','0')))
F_95 = (all_prices[0::5])
F_98 = (all_prices[1::5])
F_ON = (all_prices[2::5])
...
df_95.to_csv('C:\\Users\Tomek\PycharmProjects\scrapping\TIME\Time_95.csv', index=False)
...
df_98.to_csv('C:\\Users\Tomek\PycharmProjects\scrapping\TIME\Time_98.csv', index=False)
...
df_ON.to_csv('C:\\Users\Tomek\PycharmProjects\scrapping\TIME\Time_ON.csv', index=False)
...
df_ONN.to_csv('C:\\Users\Tomek\PycharmProjects\scrapping\TIME\Time_ON+.csv', index=False)
...
df_LPG.to_csv('C:\\Users\Tomek\PycharmProjects\scrapping\TIME\Time_LPG.csv', index=False)